...
driver = webdriver.Remote('https://' + cloudName + '.perfectomobile.com/nexperience/perfectomobile/wd/hub', options= safari_options)
...
perfecto_execution_context = PerfectoExecutionContext(webdriver=driver,
                                                              ...
                                                              project=model.Project('ExpenseMacSafari', '1.0'))

reporting_client = PerfectoReportiumClient(perfecto_execution_context)
print("Reporting client created")

# Test start
reporting_client.test_start('ExpenseMacSafariPython', TestContext(tags=['Mac', 'Safari']))
...
print('Mac Safari Python Test run ended')