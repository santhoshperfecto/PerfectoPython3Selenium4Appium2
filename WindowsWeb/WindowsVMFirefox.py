...
driver = webdriver.Remote('https://' + cloudName + '.perfectomobile.com/nexperience/perfectomobile/wd/hub', options= firefox_options)
...
perfecto_execution_context = PerfectoExecutionContext(webdriver=driver,
                                                              ...
                                                              project=model.Project('ExpenseWindowsFirefox', '1.0'))

reporting_client = PerfectoReportiumClient(perfecto_execution_context)
print("Reporting client created")

# Test start
reporting_client.test_start('ExpenseWindowsFirefoxPython', TestContext(tags=['Windows', 'Firefox']))
...
print('Windows Firefox Python Test run ended')